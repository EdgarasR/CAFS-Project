    ...
    <nav class="navbar navbar-expand-lg bg-light" id="navbar_top">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="d-flex justify-content-center navbar-nav" id="nav_ul">
                ...
                <li class="nav-item">
                    <a class="nav-link border-start" href="#">Bandomasis važiavimas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link border-start" href="#">Servisas</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link border-start border-end" href='#'>Naujienos</a>
                </li>
            </ul>
        </div>
        <!-- </div> -->
